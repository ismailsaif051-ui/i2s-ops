...
/**
 * Relaie la pièce PDF de l'ordre de mission signé — même flux que
 * /api/rapports/[id]/pdf et /api/frais/[id]/pdf.
 */
export async function GET(_request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const upstream = await fetch(`${API_URL}/missions/${id}/order/pdf`, {
